...
SDA:A4
*/
#define ADDRESS 0x50  //通信するスレーブのアドレス
...
//        data = dat2 * 0x100 + dat1; 読み出しの際
        int hogehoge_1, hogehoge_2;
        hogehoge_1 = reseaved_data[1]*0x100+reseaved_data[0];
        hogehoge_2 = reseaved_data[3]*0x100+reseaved_data[2];
        Serial.println(hogehoge_1);
        Serial.print(hogehoge_2);
